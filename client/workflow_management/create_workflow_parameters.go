...
// WithWorkflowRequest adds the workflowRequest to the create workflow params
func (o *CreateWorkflowParams) WithWorkflowRequest(workflowRequest *models.WorkflowRequest) *CreateWorkflowParams {
	o.SetWorkflowRequest(workflowRequest)
	return o
}

// SetWorkflowRequest adds the workflowRequest to the create workflow params
func (o *CreateWorkflowParams) SetWorkflowRequest(workflowRequest *models.WorkflowRequest) {
	o.WorkflowRequest = workflowRequest
}
...
func (o *CreateWorkflowParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.WorkflowRequest != nil {
		if err := r.SetBodyParam(o.WorkflowRequest); err != nil {
			return err
		}
	}
