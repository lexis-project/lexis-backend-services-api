...
// WithParameters adds the parameters to the replicate params
func (o *ReplicateParams) WithParameters(parameters ReplicateBody) *ReplicateParams {
	o.SetParameters(parameters)
	return o
}

// SetParameters adds the parameters to the replicate params
func (o *ReplicateParams) SetParameters(parameters ReplicateBody) {
