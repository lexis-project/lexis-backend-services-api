...
// WithParameters adds the parameters to the encrypt params
func (o *EncryptParams) WithParameters(parameters EncryptBody) *EncryptParams {
	o.SetParameters(parameters)
	return o
}

// SetParameters adds the parameters to the encrypt params
func (o *EncryptParams) SetParameters(parameters EncryptBody) {
