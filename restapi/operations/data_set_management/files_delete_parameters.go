...
//
// To ensure default values, the struct must have been initialized with NewFilesDeleteParams() beforehand.
...
func (o *FilesDeleteParams) bindTusResumable(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *FilesDeleteParams) validateTusResumable(formats strfmt.Registry) error {
...
func (o *FilesDeleteParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
