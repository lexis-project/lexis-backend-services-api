...
// AddGridmapEntryParams contains all the bound params for the add gridmap entry operation
// typically these are obtained from a http.Request
//
// swagger:parameters AddGridmapEntry
...
func (o *AddGridmapEntryParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
