...
// CheckDecryptionDecompressionStatusParams contains all the bound params for the check decryption decompression status operation
// typically these are obtained from a http.Request
//
// swagger:parameters CheckDecryptionDecompressionStatus
...
//
// To ensure default values, the struct must have been initialized with NewCheckDecryptionDecompressionStatusParams() beforehand.
func (o *CheckDecryptionDecompressionStatusParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CheckDecryptionDecompressionStatusParams) bindRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CheckDecryptionDecompressionStatusParams) validateRequestID(formats strfmt.Registry) error {
