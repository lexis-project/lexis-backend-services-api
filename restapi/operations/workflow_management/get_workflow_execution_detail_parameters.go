...
// GetWorkflowExecutionDetailParams contains all the bound params for the get workflow execution detail operation
// typically these are obtained from a http.Request
//
// swagger:parameters getWorkflowExecutionDetail
...
//
// To ensure default values, the struct must have been initialized with NewGetWorkflowExecutionDetailParams() beforehand.
func (o *GetWorkflowExecutionDetailParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetWorkflowExecutionDetailParams) bindWorkflowExecutionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetWorkflowExecutionDetailParams) bindWorkflowID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
