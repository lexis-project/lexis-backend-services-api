...
This repository contains a middleware service in the WP8 webportal, which is back-end to https://code.it4i.cz/lexis/wp8/wp8-portal
and front-end to user-org-service, dataset-management-interface, etc.

To run the server, enter the server directory and run
    go run main.go config.go

# LEXIS PORTAL - API (proxy) Servie
